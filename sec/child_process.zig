...
pub const ChildProcess = struct {
    ...
    proc_thread_attr_list: ?win.LPPROC_THREAD_ATTRIBUTE_LIST = null,
    ...
    pub fn wait(self: *ChildProcess) SpawnError!Term {
    ...
    fn spawnWindows(self: *ChildProcess) SpawnError!void {
        ...
        var siexStartInfoEx = win.STARTUPINFOEXW{
            .lpStartupInfo = win.STARTUPINFOW{
                .cb = @sizeOf(win.STARTUPINFOEXW),
        ...
        var piProcInfo: win.PROCESS_INFORMATION = undefined;
        ...
        const app_name_w = try unicode.utf8ToUtf16LeWithNull(self.allocator, app_basename_wtf8);
...
fn windowsCreateProcessPathExt(
    ...
    envp_ptr: ?[*]u16,
    cwd_ptr: ?[*:0]u16,
    siexStartInfoEx: *win.STARTUPINFOEXW,
...
fn windowsCreateProcess(app_name: [*:0]u16, cmd_line: [*:0]u16, envp_ptr: ?[*]u16, cwd_ptr: ?[*:0]u16, siexStartInfoEx: *win.STARTUPINFOEXW, lpProcessInformation: *win.PROCESS_INFORMATION) !void {
